# Replace all external URLs with local paths in index.html
$html = Get-Content "index.html" -Raw

# Backup original
Copy-Item "index.html" "index.html.backup"
Write-Host "Created backup: index.html.backup" -ForegroundColor Green
...
Write-Host "Original saved as: index.html.backup" -ForegroundColor Yellow
