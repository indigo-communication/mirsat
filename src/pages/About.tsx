      ...
      <section className="mirsat-section bg-gradient-to-b from-muted/50 to-background">
        <div className="mirsat-container">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <p className="text-xl text-muted-foreground arabic">عن مرساة</p>
          </div>
        </div>
      </section>
        ...
        <div className="mirsat-container">
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="space-y-6 text-right" dir="rtl">
              ...
              <p className="text-base md:text-lg text-foreground leading-relaxed arabic">
              ...
              <p className="text-sm md:text-base text-muted-foreground leading-relaxed arabic">
        ...
        <div className="mirsat-container">
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
            <div className="space-y-4">
              <div className="w-24 h-24 mx-auto rounded-full bg-gradient-to-br from-primary to-accent flex items-center justify-center text-2xl font-bold text-primary-foreground">
                KE
              </div>
              <div className="text-center">
                <h3 className="text-lg font-semibold text-foreground">Karen El-Haddad</h3>
                <p className="text-sm text-muted-foreground">Co-Founder - Brussels</p>
            ...
            <div className="space-y-4">
              <div className="w-24 h-24 mx-auto rounded-full bg-gradient-to-br from-accent to-primary flex items-center justify-center text-2xl font-bold text-primary-foreground">
                MA
              </div>
              <div className="text-center">
                <h3 className="text-lg font-semibold text-foreground">Makram Al Halabi</h3>
                <p className="text-sm text-muted-foreground">Co-Founder - Beirut</p>
                <p className="text-xs text-muted-foreground mt-2">
